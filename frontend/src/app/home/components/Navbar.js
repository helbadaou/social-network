                ...
                {notifications.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {notifications.map((notif, idx) => (
                      <div
                        key={notif.id || `${notif.sender_id}-${notif.type}-${notif.message}-${idx}`}
                      ...
                      >
                        ...
                        {notif.type === 'follow_request' && (
                          <div className="flex gap-2 mt-2">
                            <button onClick={(e) => { e.stopPropagation(); handleAccept(notif.id, notif.sender_id); }}
                              className="text-xs bg-green-600 hover:bg-green-700 text-white px-2 py-1 rounded">
                              Accepter
                            </button>
                            <button onClick={(e) => { e.stopPropagation(); handleReject(notif.id, notif.sender_id); }}
                ...
                <div className="absolute right-0 top-12 w-64 bg-gray-900 border border-gray-700 rounded-md shadow-lg p-4 z-20">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`w-12 h-6 flex items-center rounded-full p-1 duration-300 ease-in-out ${isPrivate ? 'bg-red-500' : 'bg-green-500'}`}
                    >
