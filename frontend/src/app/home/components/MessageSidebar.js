// src/app/home/components/MessageSidebar.js
'use client'

export default function MessageSidebar({ chatUsers, setShowMessages }) {
  return (
    <div
    ...
    >
      <div className="flex justify-between items-center p-4 border-b">
        ...
        <button
          onClick={() => setShowMessages(false)}  // Fermeture de la barre latérale
      ...
      <div className="overflow-y-auto max-h-[calc(100%-56px)]">
        {chatUsers.map((u) => (
          <div
            ...
            onClick={() => openChat(u)} // Tu peux ajouter une logique d'ouverture de chat ici
          >
